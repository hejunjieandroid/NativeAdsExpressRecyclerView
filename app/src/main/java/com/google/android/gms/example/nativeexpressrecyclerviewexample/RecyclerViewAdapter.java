...
class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private RecItemClickListener recItemClickListener;

    public void setRecItemClickListener(RecItemClickListener listener){
        recItemClickListener=listener;
    }
            ...
            case MENU_ITEM_VIEW_TYPE:
                ...
                menuItemHolder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        recItemClickListener.onclick(v,position);
                    }
                });
                break;
            case NATIVE_EXPRESS_AD_VIEW_TYPE:
